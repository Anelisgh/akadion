  ...
  return (
    <>
      <Button
        ...
        className="fixed right-6 bottom-6 z-40 h-[4.65rem] w-[4.65rem] rounded-[1.7rem] border border-[#d2def0] bg-linear-to-br from-white via-[#f7fbff] to-[#e7f1fb] p-0 shadow-[0_22px_54px_rgba(32,46,84,0.24)] ring-1 ring-white/60 transition hover:-translate-y-1 hover:shadow-[0_28px_64px_rgba(32,46,84,0.28)]"
      >
        <div className="flex h-full w-full items-center justify-center rounded-[1.45rem] bg-linear-to-br from-white/92 to-[#eef6ff]">
          <img src={ragLogo} alt="Aky" className="h-13 w-13 object-contain drop-shadow-[0_8px_18px_rgba(24,49,83,0.16)]" />
        </div>
      </Button>
            ...
            <Card className="border-[#d9e4f4] bg-linear-to-br from-[#edf7ff] via-[#f8fbff] to-white py-0 shadow-[0_18px_40px_rgba(32,46,84,0.08)]">
              <CardContent className="space-y-4 px-5 py-5">
                <div className="flex items-start gap-3">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-linear-to-br from-[#183153] to-[#305d86] text-white shadow-[0_12px_24px_rgba(24,49,83,0.18)]">
